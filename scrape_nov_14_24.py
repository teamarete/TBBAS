"""
Scrape November 14-24, 2025 for all UIL classifications (A-AAAAAA)
"""
...
def scrape_complete_range():
    """Scrape Nov 14-24, 2025 for complete game coverage"""

    # All dates from Nov 14-24
    dates_to_scrape = [
        "11/14/2025",
        "11/15/2025",
        "11/16/2025",
    ...
    logger.info("="*70)
    logger.info("SCRAPING COMPLETE DATE RANGE: Nov 14-24, 2025")
    logger.info("="*70)
    logger.info("")
